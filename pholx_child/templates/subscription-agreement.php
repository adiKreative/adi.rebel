<?php
/*Template Name: Subscription Aggrement */
?>
<div class="text-center">
  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/logo.png" alt="" style="max-width:100px;margin:0 0 30px 0;" />
</div>
<h2 class="text-center">
  Subscription Agreement<br/>
  <?php //if($countryCode=="US" || $countryCode == "CA"): ?>
  &<br/>
...
<hr/>
<p class="text-right">Version 1.0</p>
<!--<p class="text-right">December ____, 2017</p>-->
<br/><br/>
<p class="text-right">
  <b>Presented by:</b>
  <br/><br/>
...
<p style="text-indent: 50px;">This Subscription Agreement (“Agreement”) executed this <span class="underline"><?php echo date("jS") ?></span> day of <span class="underline"><?php echo date("F") ?></span> <?php echo date("Y") ?> by and between Punch TV Studios, Inc. (“Punch” or “Company”), located at 11705 Willake Street, Santa Fe Springs, California 90670, and “Investor”:</p>
...
<div class="row">
  ...
  <div class="columns small-10">
    <p><span class="underline"><?php echo $current_user->user_firstname; ?> <?php echo $current_user->user_lastname; ?></span></p>
    <p><span class="underline ag-address-complete"></span></p>
  </div>
</div>
<br/>
<p>Collectively, Punch and Investor shall be referred to as the “Parties” and each as the “Party.”</p>
...
<ol>
  <li>
    <p><b>Subscription.</b> At the price of $10.00 (10 dollars US) per share, Investor hereby agrees to purchase and accept:</p>
  ...
  <li>
    <p><b>Registration of Shares</b></p>
    <ol>
...
<p><b>Agreed to and accepted</b></p>
  ...
  <div class="row">
    ...
    <!--   <p>Click and drag using your mouse on the space above to sign.</p> -->

      <p>By: <?php echo $current_user->user_firstname; ?> <?php echo $current_user->user_lastname; ?> </p>
    </div>
<!--   <?php if($countryCode=="US" || $countryCode == "CA"): ?>
  <div class="columns large-6">
    <p><b>On behalf of Punch TV Studios, Inc. </b></p>
  ...
  <div class="columns large-6">
    <p><b>Investor</b></p>
    <br/>
    <p><i>Note: By signing at the end of this document, you also sign this section</i></p>
    <p>______________________________</p>
    <p>By: <?php echo $current_user->user_firstname; ?> <?php echo $current_user->user_lastname; ?> </p>
  </div>
...
<p>PUNCH TV STUDIOS, INC, a Delaware Corporation ("Company"), will use the responses to this questionnaire to qualify prospective purchasers of its Shares for purposes of federal and state securities laws. </p>
<p>If the answer to any question below is "none" or "not applicable," please so indicate. Your answers will be kept confidential; however, by signing this questionnaire, you agree that the Company may present this questionnaire to any person it deems appropriate to establish the availability of exemptions from registration pursuant to state and federal securities laws. </p>

<p><b>PART I.   INDIVIDUAL INVESTORS </b></p>
<p>(Investors that are not individuals (that is, are corporations, trusts, etc.) should start at PART II). </p>
<ol>
  <li><p>Name (as it should appear on stock certificate): <span class="underline"><?php echo $current_user->user_firstname; ?> <?php echo $current_user->user_lastname; ?></span></p></li>
  <li><p>Residence address: <span class="underline ag-address-complete"></span></p></li>
  <li><p>Home telephone: <span id="ag-phone-1" class="underline"></span></p></li>
  <li><p>Date of birth: <span id="ag-bdate" class="underline"></span></p></li>
  <li><p>Social security number: <span id="ag-ssn" class="underline"></span></p></li>
  <li>
    <p>United States citizen: <span class="underline"><?php echo $isUSorCanadian; ?></span></p>
    <p>If no, country of citizenship: <span class="underline"><?php if($countryCode == 'US'){ echo 'N/A'; }else{ echo 'Canada'; } ?></span></p>
  </li>
  <li><p>Occupation: <span id="ag-occupation" class="underline"></span></p></li>
  <li><p>Number of years: <span id="ag-occupation-years" class="underline"></span></p></li>
  <li><p>Present employer: <span id="ag-present-employer" class="underline"></span></p></li>
  <li><p>Position/Title: <span id="ag-present-position" class="underline"></span></p></li>
  <li><p>Business address: <span id="ag-business-address" class="underline"></span></p></li>
  <li><p>Business telephone: <span id="ag-business-phone" class="underline"></span></p></li>
  <li><p>Business facsimile: <span id="ag-business-fax" class="underline"></span></p></li>
  <li>
    <p>Each state and foreign country in which you have maintained your principal residence during the past three years, and the dates during which you resided in each: </p>
    <p><span id="ag-residence-countries" class="underline"></span></p>
  </li>
  <li>
    <p>Are you registered to vote in, or do you have a driver's license issued by, or do you maintain a residence in any other state or country? <span id="ag-is-not-us-resident" class="underline"></span></p>
    <p>If yes, in which state and country(ies)?:</p>
    <p><span id="ag-voter-countries" class="underline"></span></p>
  </li>
  <li>
    <p>If you have any existing personal or business relationship with the Company or any of its officers, directors or controlling persons, please describe the nature and duration of each relationship: </p>
    <p><span id="ag-relationships" class="underline"></span></p>
  </li>
  <li>
    <p>Please describe in reasonable detail the nature and extent of your business, financial and investment experience that you believe gives you the capacity to evaluate the merits and risks of the proposed investment and the capacity to protect your interests: </p>
    <p><span id="ag-investment-experience" class="underline"></span></p>
  </li>
  <li>
    <p>Are you purchasing the Offered Shares for your own account and for investment purposes only? <span id="ag-is-for-self" class="underline"></span> </p>
    <p>If no, please specify for whom you are investing and the reason for investing: <span id="ag-for-whom" class="underline"></span> </p>
  </li>
  <li>
    <p>In evaluating this investment, will you use the services of any of the following advisors? If so, please identify, providing address and telephone number: </p>
    <p>Accountant: </p>
    <p><span id="ag-accountant" class="underline"></span></p>
    <p>Attorney: </p>
    <p><span id="ag-attorney" class="underline"></span></p>
    <p>Licensed investment adviser:</p>
    <p><span id="ag-adviser" class="underline"></span></p>
  </li>
  <li><p>Anticipated amount of subscription: </p></li>
  <li>
    <p>Indicate type of ownership in which securities will be held: [Please consider carefully. Once your subscription is accepted, any change in the form of title constitutes a transfer of the Membership interest and will therefore be restricted by the terms of the by-laws and result in additional costs to you. Subscribers should seek the advice of their attorneys in deciding in which of the forms they should take ownership of the Shares. Because different forms of ownership can have varying gift tax, estate tax, income tax, and other consequences, depending on the State of the investor’s domicile and his or her particular personal circumstances]</p>
    <ul>
      <li><p>Individual Ownership (one signature required)</p></li>
      <li><p>Joint Tenants with right of survivorship and not as tenants in common (both or all parties must sign)</p></li>
      <li><p>Community Property (One signature required if interest held in one name, i.e. managing spouse; two signatures required if interest held in both names)</p></li>
      <li><p>Tenants in common (both or all parties must sign)</p></li>
    </li>
  </li>
</ol>


<p>Please go to PART III on the last page and sign and date this questionnaire. </p>
<p><b>PART II.  SIGNATURE PAGE TO INVESTOR QUESTIONNAIRE </b></p>
<p>In signing below, you acknowledge that the information provided in this questionnaire is true and correct in all material respects and that you understand that the Company and its counsel are relying on the truth and accuracy of that information in reliance on the exemption contained in Section 4(2) of the Securities Act of 1933, as amended, and Rule 505 of Regulation D. You agree to notify the Company promptly of any changes in the foregoing information that occur before the investment.</p>

<p>Executed at _________________________________, on <span class="underline"><?php echo date("F j, Y") ?></span></p>
...
<p>By:  <span class="underline"><?php echo $current_user->user_firstname; ?> <?php echo $current_user->user_lastname; ?></span></p> -->
